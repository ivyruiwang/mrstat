...
# Generate the noiseless parameter map figure
# julia --project=. scripts/plot_parammap_noiseless.jl results_single_gpu.jld2 results_mpi_1n4g.jld2 results_mpi_2n8g.jld2
...
suptitle("Noiseless Phantom Reconstruction: 1 GPU vs 4 GPUs vs 8 GPUs", fontsize=16, color="#FFB347", fontweight="bold", y=0.98)
