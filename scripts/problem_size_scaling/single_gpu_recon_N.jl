...
# MRSTAT_N=320 julia --project=. scripts/problem_size_scaling/single_gpu_recon_N.jl
...
csv_old = "solver_iter_breakdown_single_gpu.csv"
csv_new = "solver_iter_breakdown_N$(N)_single_gpu.csv"
